          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title float-left">Criminal</h3>
                <div class="w-100">
               ...
               <form action="{{ url('criminal-submit') }}" method="POST">
                ...
                <div class="form-outline mb-4">
                  ...
                  <select class="form-control"  name="case">
                    @foreach($case_number as $value)
                    <option value="{{$value->complaint_no}}">{{$value->complaint_no}}</option>
                    @endforeach
                  </select>
                </div>
